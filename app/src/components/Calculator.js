...
class Calculator extends Component {
  ...
  //Updates Header text. Not sure why you would ever need this
  updateHeader(val) {
      this.setState({
        header : val
      });
  ...
  //OnClick sets the number to the number you clicked
  setDisplay(num){
 ...
 //Tells us what operation to preform in the next step
